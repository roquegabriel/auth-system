...
/**
 * Returns true if a string has at least min length
 * @param array $data
 * @param string $field
 * @param int $min
 * @return bool
...
/**
 * Returns true if a string cannot exceed max length
 * @param array $data
 * @param string $field
 * @param int $max
 * @return bool
...
/**
 * Returns true if the value is within the range of the params
 * @param array $data
 * @param string $field
 * @param int $min
 * @param int $max
...
/**
 * Returns true is the string is alphanumeric
 * @param array $data
 * @param string $field
 * @return bool
 */
...
/**
 * Returns true if the string matches the other 
 * @param array $data
 * @param string $field
 * @param string $other
 * @return bool
 ...
 * or returns false if the connection fails
 * 
 * @return PDO
 * 
 */
...
//     if (!$pdo) {
//         $pdo = new PDO(sprintf("mysql:host=%s;dbname=%s;charset=UTF8", DB_HOST, DB_NAME), DB_USER, DB_PASSWORD, [PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION]);
//     }
//     return $pdo;
// }

/**
 * Returns true if the value is unique in the column of a table
 * @param array $data
 * @param string $field
 * @param string $table
 * @param string $column
